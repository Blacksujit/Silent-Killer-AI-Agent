...
const EnhancedSuggestions = () => {
  ...
  const exportSuggestions = () => {
    ...
    saveAs(blob, `silent-killer-suggestions-${format(new Date(), 'yyyy-MM-dd-HH-mm')}.json`)
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 sm:gap-4">
        {[
          ...
          { label: 'Rejected', value: stats.rejected, icon: XCircle, color: 'from-red-500/20 to-red-600/20' },
          { label: 'Pending', value: stats.pending, icon: Clock, color: 'from-yellow-500/20 to-yellow-600/20' },
          { label: 'Archived', value: stats.archived, icon: Archive, color: 'from-purple-500/20 to-purple-600/20' }
        ].map((stat, index) => {
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            <p className="text-gray-400 mt-4">Analyzing your patterns...</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-500">Try adjusting your filters or generate more activity</p>
          </motion.div>
        ) : (
          <motion.div
            key="suggestions"
                    ...
                    <div className="flex-1">
                      ...
                      {suggestion.suggested_action && (
                        <div className="bg-white/5 rounded-lg p-3 mb-4">
                          <p className="text-sm text-gray-400 mb-1">Suggested Action:</p>
                      ...
                      {suggestion.created_ts && (
                        <div className="text-xs text-gray-500">
                          Created: {format(new Date(suggestion.created_ts), 'MMM dd, yyyy HH:mm')}
                        </div>
                      )}
                    </div>
                  </div>
